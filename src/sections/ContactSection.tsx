...
function ContactLinkTile({
  ...
  return (
    ...
    >
      ...
      <ToneBlock
        tone={item.tone}
        className="flex h-full items-center justify-center p-4 transition-transform duration-300 group-hover:-translate-y-1 md:p-5"
      >
        <CrosshairAccent
          dark={isDark}
          driftX={accentAX}
        ...
        <Icon
          ...
          className={cn(
            ...
            isDark ? "text-[var(--acid)]" : "text-current opacity-78",
          )}
        />
      </ToneBlock>
      </RevealPanel>
...
export default function ContactSection() {
  ...
  return (
    ...
    >
      <div className="mx-auto w-full max-w-[86rem] xl:h-[min(58rem,calc(100svh-2.5rem))]">
        <RevealPanel delay={0}>
        <ToneBlock
          tone="light"
        ...
        >
          ...
          <div className="grid min-h-0 gap-4 px-4 py-5 md:gap-6 md:px-5 md:py-6 xl:grid-cols-[minmax(0,1fr)_300px]">
            ...
            <div className="grid min-h-0 grid-rows-[1fr_auto] gap-2 md:gap-3">
              ...
              <ToneBlock tone="lime" className="flex items-end justify-between gap-4 p-4 md:p-5">
